...
void Program::updateCurveIterations(Curve &curve, sf::Text &counter, sf::Keyboard::Key keyCode)
{
...
void Program::updateVertexColor(int &colorIndex, sf::Text &colorText, sf::Keyboard::Key keyCode)
{
